      ...
      if (url === "https://example.com/api/courses") {
        resolve({
          ...
          user: {
            ...
            profilePic:
              "https://images.unsplash.com/photo-1635805737707-575885ab0820?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8c3BpZGVybWFufGVufDB8fDB8fHww",
            enrolledCourses: [
